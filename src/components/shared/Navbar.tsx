...
const Navbar = () => {
    return (
        <nav className="h-24 px-[5%] fixed top-0 left-0 flex items-center justify-between w-full">
            ...
            <Link href={"/login"}>
                ...
                >
                    <div className="relative inline-flex -translate-x-2 items-center transition-all duration-700 group-hover:-translate-x-6">
                        <div className="absolute -translate-x-3 opacity-100 transition-all duration-700 group-hover:-translate-x-6 group-hover:opacity-0">
                            <Dot size={40}/>
                        </div>
